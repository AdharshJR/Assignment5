...
namespace ASGSSTN004_1.Employee_
{
    public partial class Employee : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            db.exenonquery("Delete from employee where Id ='" + Id + "'");
            GridView1.DataSource = db.exedataset("Select * from employee");
            GridView1.DataBind();
        }
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            db.exenonquery("update employee set name='" + txtname.Text + "',email='" + txtdesig.Text + "',phn=" + txtsal.Text + ",age='" + txtage.Text + "' where Id=" + Id + "");
